...
//	}
	...
	@After("execution(public * getTriangle())")
	public void afterSetName(){
		System.out.println("After triangle object");
	}
	
	@Around("execution(public void setTriangle(..))")
	public void showAroundMessage() {
		System.out.println("Set method Triangle ");
	}
	
	@AfterReturning(pointcut="execution(public String getCircle(..))", returning="value") 
    ...
    {
        System.out.println(" throwing exception after getName() of triangle" + e);
    }
}
